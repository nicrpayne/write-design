...
const CanvasToolbar = ({
  ...
  return (
    <div className="w-full h-16 border-b bg-background flex items-center px-4 gap-2">
      <TooltipProvider>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                variant="ghost"
                size="icon"
                onClick={() => onInsertElement("columns")}
              >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                variant="ghost"
                size="icon"
                onClick={() => onInsertElement("orderedList")}
              >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                variant="ghost"
                size="icon"
                onClick={() => onInsertElement("sidebar")}
              >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                variant="ghost"
                size="icon"
                onClick={() => onInsertElement("divider")}
              >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                variant="ghost"
                size="icon"
                onClick={() => onInsertElement("dropcap")}
              >
